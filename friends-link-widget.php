...
if(!empty($buffercode_fl_link1) && !empty($buffercode_fl_text1)) { ?>
                <li <?php if($buffercode_fl_bullet==2){?> style="list-style-type:none;<?php } ?>" ><!-- Buffercode.com Friends Link Widget -->
                    <a href="<?php echo $buffercode_fl_link1; ?>" <?php if ($buffercode_fl_target==1){?> target="_blank" <?php } ?>><?php echo $buffercode_fl_text1; ?>&nbsp;&nbsp;<img src="http://www.google.com/s2/favicons?domain=<?php echo $buffercode_fl_link1; ?>" />
                    </a>
                    <!-- Buffercode.com Friends Link 1 Widget -->
                </li>
<?php } 
...
if(!empty($buffercode_fl_link2) && !empty($buffercode_fl_text2)) { ?>
                <li <?php if($buffercode_fl_bullet==2){?> style="list-style-type:none;<?php } ?>" ><!-- Buffercode.com Friends Link Widget -->
                    <a href="<?php echo $buffercode_fl_link2; ?>" <?php if ($buffercode_fl_target==1){?> target="_blank" <?php } ?>><?php echo $buffercode_fl_text2; ?>&nbsp;&nbsp;<img src="http://www.google.com/s2/favicons?domain=<?php echo $buffercode_fl_link2; ?>" />
                    </a>
                    <!-- Buffercode.com Friends Link 2 Widget -->
                </li>
<?php } 
...
if(!empty($buffercode_fl_link3) && !empty($buffercode_fl_text3)) { ?>
                <li <?php if($buffercode_fl_bullet==2){?> style="list-style-type:none;<?php } ?>" ><!-- Buffercode.com Friends Link Widget -->
                    <a href="<?php echo $buffercode_fl_link3; ?>" <?php if ($buffercode_fl_target==1){?> target="_blank" <?php } ?>><?php echo $buffercode_fl_text3; ?>&nbsp;&nbsp;<img src="http://www.google.com/s2/favicons?domain=<?php echo $buffercode_fl_link3; ?>" />
                    </a>
                    <!-- Buffercode.com Friends Link 3 Widget -->
                </li>
<?php } 
...
if(!empty($buffercode_fl_link4) && !empty($buffercode_fl_text4)) { ?>
                <li <?php if($buffercode_fl_bullet==2){?> style="list-style-type:none;<?php } ?>" ><!-- Buffercode.com Friends Link Widget -->
                    <a href="<?php echo $buffercode_fl_link4; ?>" <?php if ($buffercode_fl_target==1){?> target="_blank" <?php } ?>><?php echo $buffercode_fl_text4; ?>&nbsp;&nbsp;<img src="http://www.google.com/s2/favicons?domain=<?php echo $buffercode_fl_link4; ?>" />
                    </a>
                    <!-- Buffercode.com Friends Link 4 Widget -->
                </li>
<?php } 
...
if(!empty($buffercode_fl_link5) && !empty($buffercode_fl_text5)) { ?>
                <li <?php if($buffercode_fl_bullet==2){?> style="list-style-type:none;<?php } ?>" ><!-- Buffercode.com Friends Link Widget -->
                    <a href="<?php echo $buffercode_fl_link5; ?>" <?php if ($buffercode_fl_target==1){?> target="_blank" <?php } ?>><?php echo $buffercode_fl_text5; ?>&nbsp;&nbsp;<img src="http://www.google.com/s2/favicons?domain=<?php echo $buffercode_fl_link5; ?>" />
                    </a>
                    <!-- Buffercode.com Friends Link 5 Widget -->
                </li>
<?php } 
